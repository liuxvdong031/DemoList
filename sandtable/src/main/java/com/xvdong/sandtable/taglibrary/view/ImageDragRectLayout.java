...
import com.xvdong.sandtable.taglibrary.util.BitmapHelper;
import com.xvdong.sandtable.taglibrary.util.FileUtil;
...
//                rectF = new RectF(tempRectF.left, tempRectF.top, tempRectF.right, tempRectF.bottom);
    ...
    public void setImage(String url) {
        Glide.with(photoView).load(url).into(photoView);
    }
